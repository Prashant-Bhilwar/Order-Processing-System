...
const file_proto_product_proto_rawDesc = "" +
	...
	"\bin_stock\x18\x05 \x01(\bR\ainStock\"\x1b\n" +
	"\tProductId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\";\n" +
	"\vProductList\x12,\n" +
	"\bproducts\x18\x01 \x03(\v2\x10.product.ProductR\bproducts2\x80\x01\n" +
	"\x0eProductService\x126\n" +
	"\x0eGetAllProducts\x12\x0e.product.Empty\x1a\x14.product.ProductList\x126\n" +
	"\x0eGetProductById\x12\x12.product.ProductId\x1a\x10.product.ProductB\n" +
	"Z\bgen/;genb\x06proto3"
...
var file_proto_product_proto_depIdxs = []int32{
	...
	2, // 2: product.ProductService.GetProductById:input_type -> product.ProductId
	3, // 3: product.ProductService.GetAllProducts:output_type -> product.ProductList
	1, // 4: product.ProductService.GetProductById:output_type -> product.Product
